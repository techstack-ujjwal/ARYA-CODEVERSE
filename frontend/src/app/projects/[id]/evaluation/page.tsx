...
// Agent Metadata Directory - Strictly Monochrome, Emerald Green, and Red
const AGENT_META: Record<
  string,
  { title: string; stage: "idea" | "ppt" | "product" | "cross"; stageLabel: string; desc: string; icon: any }
> = {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 w-full bg-black text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
        ...
        <Card variant="elevated" className="lg:col-span-4 flex flex-col justify-between p-6 bg-zinc-950 border-zinc-800">
          <div>
          ...
          <div className="pt-4 border-t border-zinc-800 text-[11px] font-mono space-y-1.5">
            <div className="flex justify-between text-zinc-400">
              <span>Weighted AI Index (70%):</span>
              <span className="text-white font-semibold">{aiScore.toFixed(1)} / 100</span>
            </div>
            <div className="flex justify-between text-zinc-400">
              <span>Faculty Judge Score (30%):</span>
              <span className={humanScore !== null ? "text-emerald-400 font-semibold" : "text-zinc-500"}>
        ...
        <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <div>
              ...
              <h4 className="text-sm font-bold text-white">Idea & Feasibility</h4>
          ...
          >
            <div>
              ...
              <h4 className="text-sm font-bold text-white">Architecture & Deck</h4>
              <div className="text-2xl font-mono font-black text-white mt-2">
            ...
            <div className="mt-4 pt-3 border-t border-zinc-800 text-[11px] text-zinc-400 flex items-center justify-between">
              <span>3 Agents</span>
              <span className="text-zinc-200 font-mono">Claims Mapped</span>
            </div>
          </Card>
          ...
          >
            <div>
              ...
              <h4 className="text-sm font-bold text-white">Product & Code</h4>
              <div className="text-2xl font-mono font-black text-white mt-2">
            ...
            <div className="mt-4 pt-3 border-t border-zinc-800 text-[11px] text-zinc-400 flex items-center justify-between">
              <span>5 Agents</span>
              <span className="text-emerald-400 font-mono">AST Clean</span>
            </div>
          </Card>
        </div>
      </div>
      ...
      <div className="mb-12">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs text-white hover:text-zinc-200 font-mono px-3 py-1.5 rounded-lg bg-zinc-800 border border-zinc-700 transition-colors cursor-pointer"
            >
              Expand All
            </button>
            <button
              onClick={collapseAllAgents}
              className="text-xs text-zinc-400 hover:text-white font-mono px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 transition-colors cursor-pointer"
            >
              Collapse All
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 p-1.5 bg-zinc-950 border border-zinc-800 rounded-2xl mb-8">
          <button
        ...
        {currentStageAgents.length === 0 ? (
          <Card variant="subtle" className="p-8 text-center text-zinc-400 bg-zinc-950">
          ...
          <div className="space-y-6">
            {currentStageAgents.map((ae) => {
              ...
              return (
                <Card
                  key={ae.agent_name}
                  className="bg-zinc-950 border-zinc-800 hover:border-zinc-700 transition-all overflow-hidden specular-border"
                >
                  ...
                  >
                    <div className="flex items-start sm:items-center gap-3.5">
                      ...
                      <div>
                        <div className="flex items-center gap-2 flex-wrap">
                          <h4 className="text-sm sm:text-base font-bold text-white">{meta.title}</h4>
                    ...
                    <div className="flex items-center gap-4 self-end sm:self-center shrink-0">
                      ...
                      <div className="text-zinc-500 hover:text-zinc-300 transition-colors p-1 rounded-lg bg-zinc-800">
                        {isExpanded ? (
                  ...
                  {isExpanded && (
                    <div className="p-6 border-t border-zinc-800 space-y-6 bg-black">
                      ...
                      <div>
                        ...
                        <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800 text-xs text-zinc-200 leading-relaxed font-sans whitespace-pre-line space-y-2">
                          {ae.reasoning || "Evaluation completed with automated consensus."}
                        </div>
                      </div>

                      {/* 🌟 3 Structured Actionable Suggestion Cards */}
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                          {points.map((pt, idx) => (
                            <div
                              key={idx}
                              className="p-4 rounded-xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 transition-colors flex flex-col justify-between"
                            >
                              <div>
                                <div className="flex items-center gap-2 mb-2">
                                  <span className="w-5 h-5 rounded-md bg-zinc-800 border border-zinc-700 text-white flex items-center justify-center text-[10px] font-mono font-bold">
                                    0{idx + 1}
                                  </span>
                                  <h5 className="text-xs font-bold text-white truncate">{pt.title}</h5>
                                </div>
                        ...
                        <div className="pt-4 border-t border-zinc-800">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {ae.evidence.map((ev, idx) => (
                              <div
                                key={idx}
                                className="p-3.5 rounded-xl bg-zinc-950 border border-zinc-800 font-mono text-[11px] space-y-2"
                              >
                                ...
                                <pre className="p-2.5 rounded-lg bg-black border border-zinc-800 text-[10px] text-zinc-400 overflow-x-auto max-h-28">
            ...
            {consistency.claims.length === 0 ? (
              ...
              <div className="space-y-2.5">
                {consistency.claims.map((c, i) => (
                  <div
                    key={i}
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 rounded-xl bg-zinc-900/60 border border-zinc-800 text-xs"
                  >
      ...
      <div className="mb-10">
        <Card variant="glass" className="p-6 bg-zinc-950 border-zinc-800">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-mono text-xs">
                ...
                <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800">
                  ...
                  <div className="text-sm font-bold text-white mt-1">{teacherFeedback.judge_id || "Lead Faculty Reviewer"}</div>
                </div>
                <div className="p-4 rounded-xl bg-zinc-950 border border-zinc-800">
                  <div className="text-[10px] text-zinc-500 uppercase font-semibold">Composite Split</div>
                  <div className="text-sm font-bold text-white mt-1">70% AI Swarm / 30% Judge</div>
                </div>
              </div>
            </div>
          ) : (
            <div className="mt-6 p-8 rounded-xl bg-zinc-900/40 border border-dashed border-zinc-800 text-center">
              <Clock className="w-8 h-8 text-zinc-500 mx-auto mb-2 animate-pulse" />
              <h4 className="text-sm font-semibold text-white">Awaiting Faculty Judge Review</h4>
